...
class ChartingState extends MusicBeatState
{
	public static var noteTypeList:Array<String> = // Used for backwards compatibility with 0.1 - 0.3.2 charts, though, you should add your hardcoded custom note types here too.
		['', 'Alt Animation', 'Hey!', 'Hurt Note', 'GF Sing', 'No Animation', '3D Note'];
	...
	**/
	...
	function addSectionUI():Void
	{
		...
		var is3PlayerCB = new FlxUICheckBox(check_gfSection.x, check_gfSection.y + 100, null, null, "is 3D Player");
		is3PlayerCB.checked = _song.notes[curSection].da3playerSection;
	...
	private function saveEvents()
	{
		...
		var eventsSong:SwagSong = {
			...
			stage: _song.stage,
			validScore: false,
			arrowSkinP2: _song.arrowSkinP2,
			arrowSkinP1: _song.arrowSkinP1
		};
		var json = {
			"song": eventsSong
		}

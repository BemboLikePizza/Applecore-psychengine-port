...
class CharacterEditorState extends MusicBeatState
{
	...
	function addCharacterUI()
	{
		...
		var da3D_Note_CheckBox:FlxUICheckBox = new FlxUICheckBox(healthIconInputText.x + 100, healthIconInputText.y, null, null, "Is 3D Character", 80);
		da3D_Note_CheckBox.checked = char.da3DNote;
		da3D_Note_CheckBox.callback = function()
		{
			char.da3DNote = false;
			if (da3D_Note_CheckBox.checked)
				char.da3DNote = true;
		};
		...
		tab_group.add(da3D_Note_CheckBox);

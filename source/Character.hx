...
class Character extends FlxSprite
{
	...
	public var da3DNote:Bool = false;
	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false, ?da3DNote:Bool = false)
	{
		super(x, y);
